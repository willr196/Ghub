...
create index if not exists workouts_user_type_created_idx on public.workouts (user_id, type, created_at desc);
...
create index if not exists goals_user_completed_created_idx on public.goals (user_id, completed, created_at desc);
create index if not exists sobriety_user_active_start_idx on public.sobriety (user_id, is_active, start_date desc);
create index if not exists workout_library_user_created_idx on public.workout_library (user_id, created_at desc);
...
create index if not exists blog_posts_public_created_idx on public.blog_posts (is_public, created_at desc);
create index if not exists gallery_user_date_idx on public.gallery (user_id, date desc);
create index if not exists gallery_public_date_idx on public.gallery (is_public, date desc);
create index if not exists travel_user_date_visited_idx on public.travel (user_id, date_visited desc);
create index if not exists travel_public_date_visited_idx on public.travel (is_public, date_visited desc);
